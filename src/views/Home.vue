...
import { Clock, Color, Fog, Group, Mesh, MeshBasicMaterial, MeshMatcapMaterial, MeshToonMaterial, PerspectiveCamera, PointLight, Scene, TextureLoader, TorusGeometry, Vector3, WebGLRenderer } from 'three';
...
fontLoader.load(typefaceFont, (font) => {
  ...
  const torusMaterial = new MeshMatcapMaterial({ matcap: torusMap })
